...
const usb_talk_subscribe_t subscribes[] = {
    ...
    {"vv-display/-/power/set", update_vv_display, VV_RADIO_DATA_TYPE_L1_POWER, NULL},
    {"vv-display/-/fve/set", update_vv_display, VV_RADIO_DATA_TYPE_FVE_POWER, NULL},
    {"vv-display/-/living-room/set", update_vv_display, VV_RADIO_DATA_TYPE_TEMPERATURE_LIVING_ROOM, NULL},
    {"vv-display/-/terrace/set", update_vv_display, VV_RADIO_DATA_TYPE_TEMPERATURE_TERRACE, NULL},
    {"vv-display/-/bedroom/set", update_vv_display, VV_RADIO_DATA_TYPE_TEMPERATURE_BEDROOM, NULL},
    {"vv-display/-/co2/set", update_vv_display, VV_RADIO_DATA_TYPE_CO2, NULL},
    {"vv-display/-/thermostat/set", update_vv_display, VV_RADIO_DATA_TYPE_THERMOSTAT_REFERENCE_VALUE, NULL}    
};
